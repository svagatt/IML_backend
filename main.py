...
feature_extraction_methods = ['mean', 'skewness', 'std', 'variance']
use_autoreject = False
filter_methods = 'cheby2'
# channels = ['C4', 'FC3', 'FC1', 'F5', 'C3', 'F7', 'FT7', 'CZ', 'C5', 'T7', 'P3']
parameters = Parameters(subject, filter_methods, use_autoreject, feature_extraction_methods)
...
cut_epochs_by_event_id(event_dict, subject, use_autoreject=use_autoreject)
