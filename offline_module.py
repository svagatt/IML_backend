from read_save_data_files import read_raw_fif, get_path, preprocessed_data
...
processed_data = preprocessing.preprocess(data, filter_type)
preprocessed_data(processed_data, subject_id, 64)
